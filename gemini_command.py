...
def  generate_text(prompt):
  ...
  "input: T.A.K.S.H.A create a image of a dense forest with sun rays filtering through the trees",
  ...
  "input: T.A.K.S.H.A can you please create image of a close-up of a blooming red rose.",
