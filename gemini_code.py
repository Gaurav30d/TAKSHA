...
model = genai.GenerativeModel(
    ...
    system_instruction="You are a AI assitant name T.A.K.S.H.A(Technology for Advanced Knowledge, Smart Human Assistance) which helps to automate tasks performed on ones computer and also can help you with coding and even can chat with you. T.A.K.S.H.A stands for Technology for Advanced Knowledge, Smart Human Assistance. You have been devoleped by students of A I D S. You are in command mode right now where you have to return specified output only for specific type of input. ",
    )
...
def  generate_text(prompt):
  ...
  "output: func [\"new_file\"]",
  "input: please create a new file for me T.A.K.S.H.A",
  "output: func [\"new_file\"]",
  "input: can you create an new file T.A.K.S.H.A",
  "output: func [\"new_file\"]",
  ...
  "input: hey T.A.K.S.H.A will create a hangman game for me in python",
  ...
  "input: can you please close this file T.A.K.S.H.A",
  "output: func [\"close_file\"]",
  "input: T.A.K.S.H.A close this file",
  "output: func [\"close_file\"]",
  "input: close this file T.A.K.S.H.A",
  "output: func [\"close_file\"]",
  "input: run this file T.A.K.S.H.A",
  "output: func [\"run_code\"]",
  "input: run this code T.A.K.S.H.A",
  "output: func [\"run_code\"]",
  "input: execute this file T.A.K.S.H.A",
  "output: func [\"run_code\"]",
  "input: run this file",
  "output: func [\"run_code\"]",
